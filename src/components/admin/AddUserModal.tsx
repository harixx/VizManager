...
import { X, Mail, User, Shield, Eye, EyeOff } from 'lucide-react';
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                readOnly
                className={`w-full pr-10 pl-3 py-2 lg:py-3 border rounded-lg transition-colors ${
                  isDarkMode 
            ...
            <p className={`text-xs mt-1 ${
              ...
              This password will be shared with the user. They can change it after first login.
            </p>
          </div>
